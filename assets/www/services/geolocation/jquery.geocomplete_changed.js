...
// function initGeocoder is not initialized
// instead we use initGeocoderChanged
// by S.Kouremenos
...
;(function($, window, document, undefined){
  ...
  $.extend(GeoComplete.prototype, {
	...
	// function: initGeocoderChanged
	// Author: S.Kouremenos
	// used instead of initGeocoder function in order to prevent
	// the default Autocomplete Module
	
	initGeocoderChanged: function(){
